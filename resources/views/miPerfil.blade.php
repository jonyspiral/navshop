    ...
    <div id="main" class=" styleLogin padd2" style="  margin: 2%;" >
        ...
        <div class="">
           <form class="" action="miPerfil" method="post" enctype="multipart/form-data" >
               ...
               <input type="text" class="form-control" id="user" placeholder="Enter user"   name="user" value=""  >
               <p> </p>

               <label  class="center" name="email"  ><strong> </strong> </label>
               <p> </p>

               <input type="text" class="form-control" id="name" placeholder="Enter name"   name="name" value=""  >
               <p></p>

               <input type="text" class="form-control" id="lastName" placeholder="Enter lastName"   name="lastName" value="" required>
               <p></p>
